        ...
        >
          ...
          <div className="relative">
            ...
            <div className="mt-9 flex flex-wrap items-center justify-center gap-4">
              ...
              <Link
                href="/contact"
                className="group/btn inline-flex items-center gap-2 rounded-xl bg-white px-7 py-3.5 font-semibold text-bordeaux shadow-[0_10px_30px_-10px_rgb(var(--accent-dark)/0.7)] transition-transform duration-200 hover:-translate-y-0.5"
              >
                {button}
                <span
                  aria-hidden="true"
